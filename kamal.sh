...
if [[ ! -e celeb_id ]]; then
printf "%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n" $diljitdosanjh $rajvirjawandaofficial $anushkasharma $nehakakkar $akshaykumar $jacquelinef143 $shraddhakapoor $aliaabhatt $deepikapadukone $priyankachopra $gururandhawa $mankirtaulakh $gippygrewal $sidhu_moosewala $karanaujla_official $cristiano> celeb_id
fi
